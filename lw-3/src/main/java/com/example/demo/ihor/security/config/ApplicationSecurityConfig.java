...
import com.example.demo.ihor.security.filters.JwtAuthenticationFilter;
import com.example.demo.ihor.security.jwt.JwtTokenProvider;
import com.example.demo.ihor.security.service.ApplicationUserService;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers("/accounts/unblock").hasRole("ADMIN")
                .and()
